import TOKENS, { Token, TokenSymbol } from "./tokens";
...
const ROUTERS: {
  ...
  [RouterName.DeFiKingdoms]: {
    ...
    PATHS: {
      ...
      [TOKENS[TokenSymbol.BUSD].ADDRESSES[ChainID.Mainnet]]:
        TOKENS[TokenSymbol.JEWEL].ADDRESSES[ChainID.Mainnet],
      [TOKENS[TokenSymbol.FTM].ADDRESSES[ChainID.Mainnet]]:
        TOKENS[TokenSymbol.JEWEL].ADDRESSES[ChainID.Mainnet],
      [TOKENS[TokenSymbol.BUSD].ADDRESSES[ChainID.Mainnet]]:
        TOKENS[TokenSymbol.JEWEL].ADDRESSES[ChainID.Mainnet],
  ...
  [RouterName.SushiSwap]: {
    ...
    PATHS: {
      [TOKENS[TokenSymbol.AXS].ADDRESSES[ChainID.Mainnet]]:
        TOKENS[TokenSymbol.ETH].ADDRESSES[ChainID.Mainnet],
      [TOKENS[TokenSymbol.YGG].ADDRESSES[ChainID.Mainnet]]:
        TOKENS[TokenSymbol.ETH].ADDRESSES[ChainID.Mainnet],
      [TOKENS[TokenSymbol.AAVE].ADDRESSES[ChainID.Mainnet]]:
        TOKENS[TokenSymbol.ETH].ADDRESSES[ChainID.Mainnet],
      [TOKENS[TokenSymbol.FRAX].ADDRESSES[ChainID.Mainnet]]:
        TOKENS[TokenSymbol.ETH].ADDRESSES[ChainID.Mainnet],
      [TOKENS[TokenSymbol.UST].ADDRESSES[ChainID.Mainnet]]:
        TOKENS[TokenSymbol.ETH].ADDRESSES[ChainID.Mainnet],
      [TOKENS[TokenSymbol.MIS].ADDRESSES[ChainID.Mainnet]]:
